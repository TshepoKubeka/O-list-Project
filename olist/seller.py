...
class Seller:
    ...
    def get_review_score(self):
        ...
        df_per_seller = df.groupby('seller_id', as_index = False)\
    ...
    def get_training_data(self):
        ...
        df=df.merge(self.get_review_score(), on='seller_id'
               )
        monthly_fee = 80
        sales_cut = 0.1
        
        df['revenue'] = monthly_fee* df['months_on_olist'] + df['sales']*sales_cut
        df['profit'] = df['revenue'] -df['cost_of_reviews'] 
